        ...
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
            ...
            <div class="user-nav d-sm-flex d-none">
              <span class="user-name font-weight-bolder">{{ Auth::check()? Auth::user()->name : ''}}</span>
              <span class="user-status">{{ Auth::check()? Auth::user()->roles->first()->display_name : ''}}</span>
            </div>
            <span class="avatar">
              <img class="round" src="{{asset('images/portrait/small/avatar-s-11.png')}}" alt="avatar" height="40"
                width="40">
